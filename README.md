...
# 6. 具体的な事例
# 6-1. MongoDB 難易度★
単に、MongoDBをコンテナ経由で使うものです。何らかのデータをロードして、データベースとして機能しているかをお試しするものです。

> https://github.com/developer-onizuka/mongodb

<img src="https://idealump.com/cms_files/posts/464/1_QJnvahq_EBdUGjYQUYrhvA.png" width="640"><br>
